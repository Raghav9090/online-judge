  ...
  return (
    <div className="p-6 text-gray-900 dark:text-gray-200 bg-white dark:bg-[#0f0f0f]">
      ...
      <section className="mb-6">
        <div
          className="text-gray-800 dark:text-gray-300 leading-relaxed prose dark:prose-invert"
      ...
      <section className="mb-4">
        ...
        <div
          className="text-sm text-gray-700 dark:text-gray-400 mt-1 prose dark:prose-invert"
          dangerouslySetInnerHTML={{
            __html: DOMPurify.sanitize(problem.inputFormat || ""),
          }}
        />
      </section>
      ...
      <section className="mb-4">
        ...
        <div
          className="text-sm text-gray-700 dark:text-gray-400 mt-1 prose dark:prose-invert"
          dangerouslySetInnerHTML={{
            __html: DOMPurify.sanitize(problem.outputFormat || ""),
          }}
        />
      </section>
      ...
      <section className="mt-6">
        ...
        <div className="bg-gray-100 dark:bg-zinc-900 border border-gray-300 dark:border-gray-600 p-4 rounded text-sm">
          <p className="text-gray-800 dark:text-gray-300 whitespace-pre-line">
            ...
            {problem.sampleInput}
            <br />
            <span className="block mt-2 font-semibold text-gray-600 dark:text-gray-400">
              Output:
            </span>
